...
import 'package:flutter_maui_bridge/flutnet/data/flutnet_error_code.dart';
...
class FlutnetException extends PlatformOperationException {
  ...
  factory FlutnetException.fromJson(Map<dynamic, dynamic> json) =>
      _$FlutnetExceptionFromJson(json);
