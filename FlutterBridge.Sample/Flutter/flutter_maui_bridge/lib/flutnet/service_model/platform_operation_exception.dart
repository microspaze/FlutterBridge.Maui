...
import 'package:flutter_maui_bridge/flutnet/data/flutnet_exception.dart';
...
class PlatformOperationException extends Object implements Exception {
  ...
  factory PlatformOperationException.fromJson(Map<dynamic, dynamic> json) =>
      _$PlatformOperationExceptionFromJson(json);

  Map<String, dynamic> toJson() => _$PlatformOperationExceptionToJson(this);

  static final Map<String,
          PlatformOperationException Function(Map<String, dynamic>)>
      _typeToPlatformOperationException = {
    'Flutnet.Data.FlutnetException': (Map<String, dynamic> json) =>
        FlutnetException.fromJson(json),
    'Flutnet.ServiceModel.PlatformOperationException':
        (Map<String, dynamic> json) =>
            PlatformOperationException.fromJson(json),
  };
